...
const double FlameEffect::flamecolors_[22][3] = {{SCALERVAL, 0, 0},
                                                 {SCALERVAL, 0, 0},
                                                 {SCALERVAL, 0, 0},
                                                 {SCALERVAL, 0, 0},
                                                 {SCALERVAL, 0, 0},
...
int FlameEffect::GetStepSize() { return random(70) + 1; }

int FlameEffect::GetMaxBrightness() { return random(rez_range_ / 2) + rez_range_ / 2; }
